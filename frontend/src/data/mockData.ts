...
export const mockAnalysisHistory = [
    {
        ...
        filename: 'bank-statement-march-2024.pdf',
        bankName: 'Chase Bank',
        analysisDate: '2024-03-15T10:30:00.000Z',
        status: 'COMPLETED' as const,
    ...
    },
    {
        ...
        filename: 'feb-statement.pdf',
        bankName: 'Wells Fargo',
        analysisDate: '2024-02-28T14:15:00.000Z',
        status: 'COMPLETED' as const,
        recommendationCount: 3,
        riskProfile: 'MEDIUM' as const,
        averageBalance: 87500,
        topRecommendation: {
            productName: 'Corporate Bond Fund',
            expectedReturn: 6.2
        }
    },
    {
        ...
        analysisDate: '2024-01-31T09:45:00.000Z',
    ...
    },
    {
        ...
        filename: 'december-2023.pdf',
        bankName: 'Chase Bank',
        analysisDate: '2023-12-29T16:20:00.000Z',
        status: 'COMPLETED' as const,
        recommendationCount: 4,
        riskProfile: 'HIGH' as const,
        averageBalance: 245000,
        topRecommendation: {
            productName: 'Growth Investment Portfolio',
            expectedReturn: 8.5
        }
    },
    {
        id: 'analysis-127',
        statementId: 'stmt-127',
        filename: 'november-statement.xlsx',
        bankName: 'Citibank',
        analysisDate: '2023-11-30T11:10:00.000Z',
        status: 'PROCESSING' as const,
        recommendationCount: 0,
        riskProfile: 'MEDIUM' as const,
        averageBalance: 156000
    }
];
