...
const getSupportedFormatsTool: MCPTool = {
...
const getStatementByIdTool: MCPTool = {
...
const getUserStatementsTool: MCPTool = {
...
const validateFileFormatTool: MCPTool = {
    ...
    fn: async (inputs: { mimeType: string; extension: string }) => {
...
const updateStatementStatusTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        const statement = await statementService.updateStatementStatus(
            id,
            status,
...
const generateSignedUrlTool: MCPTool = {
