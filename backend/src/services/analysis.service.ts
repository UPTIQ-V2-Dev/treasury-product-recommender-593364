...
import { AnalysisResult, AnalysisStatus } from '../generated/prisma/index.js';
 ...
 */
const getAnalysisById = async (analysisId: string, userId: number): Promise<AnalysisResult | null> => {
 ...
 */
const getAnalysisResults = async (analysisId: string, userId: number): Promise<AnalysisResult> => {
 ...
 * @returns {Promise<AnalysisResult>}
 */
const createAnalysis = async (statementId: string, userId: number): Promise<AnalysisResult> => {
