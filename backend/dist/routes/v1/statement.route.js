import { statementController } from "../../controllers/index.js";
import { upload } from "../../controllers/statement.controller.js";
...
router
    .route('/formats')
    .get(auth('getStatementFormats'), validate(statementValidation.getFormats), statementController.getSupportedFormats);
router
    .route('/upload')
    .post(auth('uploadStatement'), upload, validate(statementValidation.uploadStatement), statementController.uploadStatement);
router
    .route('/:id')
